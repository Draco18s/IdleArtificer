...
namespace Assets.draco18s.artificer.quests.challenge.goals {
	public class GoalCleansCorruption : ObstacleType, IQuestGoal {
		public GoalCleansCorruption() : base("cleasing corrupted area", new RequireWrapper(RequirementType.DISPELLING), new RequireWrapper(RequirementType.HEALING)) {
