...
namespace Assets.draco18s.artificer.init {
	public class Industries {
		...
		//end cost tweak
		public static readonly Industry GOLD_ORE =			new Industry("gold_ore",			 new BigInteger(1 ,13),   200000000, 1, Scalar._0_RAW).setDisallowedForQuests();
		public static readonly Industry GOLD_DUST = 		new Industry("gold_dust",			 new BigInteger(25,12),   100000000, 2, Scalar._1_REFINED, new IndustryInput(GOLD_ORE,1)).setDisallowedForQuests();
		public static readonly Industry GOLD_INGOTS = 		new Industry("gold_ingots",			 new BigInteger(5 ,13),   200000000, 2, Scalar._4_RARE, new IndustryInput(GOLD_DUST,1)).setDisallowedForQuests();
		public static readonly Industry HOLY_SYMBOL = 		new Industry("holy_symbol",			 new BigInteger(3, 14),   500000000, 1, Scalar._1_REFINED, new IndustryInput(IRON_INGOTS,1),new IndustryInput(GOLD_INGOTS,1)).setConsumable(true).setMaxStackSize(3).addReqType(RequirementType.UNHOLY_IMMUNE).setStackSizeForQuest(5).setEffectiveness(0.75f);
		public static readonly Industry UNHOLY_SYMBOL = 	new Industry("unholy_symbol",		 new BigInteger(3, 14),   500000000, 1, Scalar._1_REFINED, new IndustryInput(IRON_INGOTS,1),new IndustryInput(GOLD_INGOTS,1)).setConsumable(true).setMaxStackSize(3).addReqType(RequirementType.HOLY_IMMUNE).setStackSizeForQuest(5).setEffectiveness(0.75f);
		public static readonly Industry ARMOR_CHAIN =		new Industry("chainmail_armor",		 new BigInteger(75, 13),  1500000000, 1, Scalar._2_SIMPLE, new IndustryInput(IRON_RING, 16)).addAidType(AidType.MEDIUM_ARMOR).setMaxStackSize(1).setIsViableRelic(true).setEquipType(ItemEquipType.ARMOR).setStackSizeForQuest(1);
		public static readonly Industry IRON_SHIELD = 		new Industry("iron_shield",			 new BigInteger(225,13),  1000000000, 1, Scalar._2_SIMPLE, new IndustryInput(IRON_INGOTS,3)).addAidType(AidType.LIGHT_SHIELD).setMaxStackSize(1).setIsViableRelic(true).setEquipType(ItemEquipType.SHIELD).setStackSizeForQuest(1).setEffectiveness(1.25f);
		public static readonly Industry FANCY_BOTTLES =		new Industry("fancy_bottles",		 new BigInteger(15,15),   500000000, 5, Scalar._2_SIMPLE, new IndustryInput(GLASS, 4), new IndustryInput(CHARCOAL, 1), new IndustryInput(GOLD_INGOTS, 1)).setDisallowedForQuests().setMaxStackSize(4);
		public static readonly Industry HOLY_WATER =		new Industry("holy_water",			 new BigInteger(5,16),    6000000000, 1, Scalar._3_COMPLEX, new IndustryInput(FANCY_BOTTLES, 1), new IndustryInput(HOLY_SYMBOL, 1)).setConsumable(true).setMaxStackSize(5).addReqType(RequirementType.HOLY_DAMAGE).setStackSizeForQuest(2);
		public static readonly Industry UNHOLY_WATER =		new Industry("unholy_water",		 new BigInteger(5,16),    6000000000, 1, Scalar._3_COMPLEX, new IndustryInput(FANCY_BOTTLES, 1), new IndustryInput(UNHOLY_SYMBOL, 1)).setConsumable(true).setMaxStackSize(5).addReqType(RequirementType.UNHOLY_DAMAGE).setStackSizeForQuest(2);
		public static readonly Industry KELPWEED =			new Industry("kelpweed",			 new BigInteger(15,16),   2500000000, 5, Scalar._0_RAW).setDisallowedForQuests();
		public static readonly Industry STONEROOT =			new Industry("stoneroot",			 new BigInteger(15,16),   2500000000, 5, Scalar._0_RAW).setDisallowedForQuests();
		public static readonly Industry SAGE_GRASS =		new Industry("sage_grass",			 new BigInteger(15,16),   2500000000, 5, Scalar._0_RAW).setDisallowedForQuests();
		public static readonly Industry PHOENIX_FEATHERS =	new Industry("phoenix_feather",		 new BigInteger(15,16),   2500000000, 5, Scalar._0_RAW).setDisallowedForQuests();
		public static readonly Industry POT_WATER_BREATH =	new Industry("water_breath_potion",	 new BigInteger(5,17),   25000000000, 1, Scalar._3_COMPLEX, new IndustryInput(FANCY_BOTTLES, 1), new IndustryInput(KELPWEED, 1)).setConsumable(true).setMaxStackSize(5).addReqType(RequirementType.WATER_BREATH).setStackSizeForQuest(2).setEffectiveness(0.75f);
		public static readonly Industry POT_BARKSKIN =		new Industry("barkskin_potion",		 new BigInteger(5,17),   25000000000, 1, Scalar._3_COMPLEX, new IndustryInput(FANCY_BOTTLES, 1), new IndustryInput(STONEROOT, 1)).setConsumable(true).setMaxStackSize(5).addAidType(AidType.BARKSKIN).setStackSizeForQuest(2);
		public static readonly Industry POT_ALERTNESS =		new Industry("alertness_potion",	 new BigInteger(5,17),   25000000000, 1, Scalar._3_COMPLEX, new IndustryInput(FANCY_BOTTLES, 1), new IndustryInput(SAGE_GRASS, 1)).setConsumable(true).setMaxStackSize(5).addReqType(RequirementType.DETECTION).setStackSizeForQuest(2);
		public static readonly Industry POT_REVIVE =		new Industry("revive_potion",		 new BigInteger(5,17),   25000000000, 1, Scalar._3_COMPLEX, new IndustryInput(FANCY_BOTTLES, 1), new IndustryInput(PHOENIX_FEATHERS, 1), new IndustryInput(POT_RESTORATION, 1)).setConsumable(true).setMaxStackSize(1).addAidType(AidType.RESSURECTION).setStackSizeForQuest(1);
		public static readonly Industry GOLD_RING = 		new Industry("gold_ring",			 new BigInteger(15,17),   50000000000, 2, Scalar._4_RARE, new IndustryInput(GOLD_INGOTS, 1)).setMaxStackSize(1).setEquipType(ItemEquipType.RING).setIsViableRelic(true).setStackSizeForQuest(1);
		...
		public static class IndustryTypes {
			...
			public static readonly Industry[] TYPE_ANIMAL = { LEATHER, LEATHER_BOOTS, ARMOR_LEATHER, LIGHT_CROSSBOW, LIGHT_CLOAK, IMPROVED_CLOAK, PHOENIX_FEATHERS };//7
			...
			public static readonly Industry[] TYPE_GOLD = { GOLD_ORE, GOLD_DUST, GOLD_INGOTS, HOLY_SYMBOL, UNHOLY_SYMBOL, FANCY_BOTTLES, GOLD_RING };//7
