...
namespace Assets.draco18s.artificer.init {
	public class Industries {
		...
		public static readonly Industry SIMPLE_TOOLS =		new Industry("simple_tools",						   50000, 300, 2, Scalar._1_REFINED, new IndustryInput(WOOD, 1)).addReqType(RequirementType.TOOLS).setConsumable(true).setMaxStackSize(10).setStackSizeForQuest(1);//simple tools
		...
		public static readonly Industry IRON_SWORD =		new Industry("iron_sword",			 new BigInteger(5,11),    3200000, 1, Scalar._2_SIMPLE, new IndustryInput(IRON_INGOTS, 2)).addAidType(AidType.WEAPON).setEquipType(ItemEquipType.WEAPON).setIsViableRelic(true).setMaxStackSize(1).setStackSizeForQuest(2);
		...
		public static readonly Industry IMPROVED_CLOAK =	new Industry("improved_cloak",		 new BigInteger(750, 9),  8000000, 1, Scalar._2_SIMPLE, new IndustryInput(LIGHT_CLOAK, 2)).setIsViableRelic(true).addReqType(RequirementType.STEALTH).setEquipType(ItemEquipType.CLOAK).setStackSizeForQuest(1).setEffectiveness(0.5f);
		public static readonly Industry IRON_HELMET =		new Industry("iron_helm",			 new BigInteger(3, 12),   12500000, 1, Scalar._2_SIMPLE, new IndustryInput(IRON_INGOTS, 4)).addAidType(AidType.MEDIUM_ARMOR).setIsViableRelic(true).setEquipType(ItemEquipType.HELMET).setStackSizeForQuest(1).setEffectiveness(0.2f);
		public static readonly Industry POT_WEAKNESS = 		new Industry("weakness_potion",		 new BigInteger(10, 12),  25000000, 1, Scalar._3_COMPLEX, new IndustryInput(POT_STRENGTH,1),new IndustryInput(POT_POISON,1)).addReqType(RequirementType.WEAKNESS).setMaxStackSize(5).setStackSizeForQuest(1);
		public static readonly Industry POT_CLUMSINESS = 	new Industry("clumsiness_potion",	 new BigInteger(10, 12),  25000000, 1, Scalar._3_COMPLEX, new IndustryInput(POT_AGILITY, 1), new IndustryInput(POT_POISON, 1)).addReqType(RequirementType.CLUMSINESS).setMaxStackSize(5).setStackSizeForQuest(1);
		public static readonly Industry POT_STUPIDITY= 		new Industry("stupidity_potion",	 new BigInteger(10, 12),  25000000, 1, Scalar._3_COMPLEX, new IndustryInput(POT_INTELLIGENCE, 1), new IndustryInput(POT_POISON, 1)).addReqType(RequirementType.STUPIDITY).setMaxStackSize(5).setStackSizeForQuest(1);
		public static readonly Industry POT_UGLINESS = 		new Industry("ugliness_potion",		 new BigInteger(10, 12),  25000000, 1, Scalar._3_COMPLEX, new IndustryInput(POT_CHARISMA, 1), new IndustryInput(POT_POISON, 1)).addReqType(RequirementType.UGLINESS).setMaxStackSize(5).setStackSizeForQuest(1);
		...
		public static readonly Industry GOLD_DUST = 		new Industry("gold_dust",			 new BigInteger(25,13),   100000000, 2, Scalar._1_REFINED, new IndustryInput(GOLD_ORE,1)).setDisallowedForQuests();
		public static readonly Industry GOLD_INGOTS = 		new Industry("gold_ingots",			 new BigInteger(5 ,14),   200000000, 2, Scalar._4_RARE, new IndustryInput(GOLD_DUST,1)).setDisallowedForQuests();
		...
		public static readonly Industry IRON_SHIELD = 		new Industry("iron_shield",			 new BigInteger(225,14),  1000000000, 1, Scalar._2_SIMPLE, new IndustryInput(IRON_INGOTS,3)).addAidType(AidType.LIGHT_SHIELD).setMaxStackSize(1).setIsViableRelic(true).setEquipType(ItemEquipType.SHIELD).setStackSizeForQuest(1).setEffectiveness(1.25f);
		...
		public static readonly Industry GOLD_CROWN = 		new Industry("gold_crown",			 new BigInteger(1,20),	  2500000000000, 1, Scalar._4_RARE, new IndustryInput(GOLD_DUST, 4), new IndustryInput(SAGE_GRASS, 4)).setMaxStackSize(1).setEquipType(ItemEquipType.HELMET).setIsViableRelic(true).setStackSizeForQuest(1).setEffectiveness(0.75f);
		...
		public static class IndustryTypes {
			...
			public static readonly Industry[] TYPE_POTION1 = { POT_HEALTH, POT_MANA, POT_POISON, POT_STRENGTH, POT_AGILITY, POT_INTELLIGENCE, POT_CHARISMA, POT_RESTORATION };//8
			public static readonly Industry[] TYPE_POTION2 = { POT_WEAKNESS, POT_CLUMSINESS, POT_STUPIDITY, POT_UGLINESS, POT_WATER_BREATH, POT_BARKSKIN, POT_ALERTNESS, POT_REVIVE };//8
