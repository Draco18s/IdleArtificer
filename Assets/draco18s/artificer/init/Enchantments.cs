...
namespace Assets.draco18s.artificer.init {
	public class Enchantments {
		...
		public static Enchantment CHARISMATIC = new Enchantment("Charismatic", Industries.POT_CHARISMA.industryItem, 30000, ItemEquipType.HELMET, RequirementType.CHARISMA);
		...
		public static Enchantment DISPELLING = new Enchantment("Antimagic", Industries.BANROOT.industryItem, 30000, ItemEquipType.SHIELD, RequirementType.DISPELLING);

		//boots
		public static Enchantment STRONG = new Enchantment("Strong", Industries.POT_STRENGTH.industryItem, 30000, ItemEquipType.BOOTS, RequirementType.STRENGTH);
		public static Enchantment AGILE = new Enchantment("Agile", Industries.POT_AGILITY.industryItem, 30000, ItemEquipType.BOOTS, RequirementType.AGILITY);
		public static Enchantment FLEET = new EnchantmentHaste("Fleet", Industries.BLOOD_MOSS.industryItem, 30000, ItemEquipType.BOOTS);
	}
}
