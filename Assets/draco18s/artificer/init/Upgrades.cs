	...
	public static class Upgrades {
		public static class Cash {
			...
			public static Upgrade HALVE_DOUBLE_PHOENIX2 =		new UpgradeHalveDouble  (new BigInteger(5, 50), Industries.PHOENIX_FEATHERS, "HALVE_DOUBLE_PHOENIX_FEATHERS2");
				...
				public static Upgrade RESEARCH2 =					new UpgradeResearchSpeed(new BigInteger(1, 52), 0.05f, "RESEARCH2");
		...
		public static class Renown {
			...
			public static Upgrade RESEARCH5 =				new UpgradeResearchSpeed (new BigInteger(75,  8), 0.5f, "RESEARCH5");
			...
			public static Upgrade START_CASH5 =				new UpgradeStartingCash	 (new BigInteger(1,  11), 10, "START_CASH6");
